    ...
    public class BTL : SoulsFile<BTL> {
        ...
        public class Light {
            ...
            public Light() {
                ...
                ShadowColor = new Color(100, 0, 0, 100);
            ...
            internal void Write(BinaryWriterEx bw, long nameOffset, int version) {
                bw.WriteBytes(Unk00);
            ...
            private static void WriteRGB(BinaryWriterEx bw, Color color) {
                bw.WriteByte((byte)color.R);
                bw.WriteByte((byte)color.G);
                bw.WriteByte((byte)color.B);
            }
        }
    }
}
