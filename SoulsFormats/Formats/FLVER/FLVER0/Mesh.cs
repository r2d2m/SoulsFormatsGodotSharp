                        ...
                        if (vi1 == 0xFFFF || vi2 == 0xFFFF || vi3 == 0xFFFF) {
                            ...
                            if (vi1 != vi2 && vi1 != vi3 && vi2 != vi3) {
                                ...
                                if (checkFlip) {
                                    ...
                                    Vector3 vertexNormal = (n1.Normalized() + n2.Normalized() + n3.Normalized() / 3);
                                    Vector3 faceNormal = ((v2.Position - v1.Position).Cross(v3.Position - v1.Position)).Normalized();
                                    float angle = faceNormal.Dot(vertexNormal) / (faceNormal.Length() * vertexNormal.Length());
                                    flip = angle >= 0;
                                    checkFlip = false;
                                }
